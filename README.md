...
> This repository is strictly a **Portfolio Showcase** for employment evaluation. The code within is proprietary and all rights are reserved. You may not use, copy, or distribute this code for personal or commercial projects. This framework is currently being finalized for a commercial release on the Unreal Engine / FAB Marketplace.
